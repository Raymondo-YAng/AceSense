  ...
  return React.createElement('div', { className: 'flex flex-col h-full' },
    ...
    React.createElement('div', { className: 'flex-1 flex flex-col px-4 pt-5' },
      ...
      React.createElement('div', { className: 'flex flex-col gap-3 mt-4 items-stretch max-w-md mx-auto w-full' },
        React.createElement(Button, { variant: 'primary', onClick: handleAction, fullWidth: true }, 'Upload from library'),
        React.createElement(Button, { variant: 'secondary', onClick: handleAction, fullWidth: true }, 'Record a new video')
      )
    )
  );
}
